...
module GradeDiff
  ...
  GradeDiffStruct = Struct.new(:grade, :diff)
  ...
  # @return [GradeDiffStruct]
  def grade_diff
    return GradeDiffStruct.new(GRADE[:f], 0) if score.nil?
    return GradeDiffStruct.new(GRADE[:max], 0) if score >= map.max_score
    ...
    GradeDiffStruct.new(GRADE[grade], diff)
  end
