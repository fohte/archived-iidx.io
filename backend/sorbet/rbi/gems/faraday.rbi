...
class Faraday::RequestOptions < Anonymous_Faraday_Options_19
  def []=(key, value); end
end
class Anonymous_Faraday_Options_20 < Faraday::Options
  def ca_file; end
  def ca_file=(_); end
  def ca_path; end
  def ca_path=(_); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_20
  def disable?; end
  def verify?; end
end
class Anonymous_Faraday_Options_21 < Faraday::Options
  def password; end
  def password=(_); end
  def self.[](*arg0); end
  def self.inspect; end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_21
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_22
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_23
  def [](key); end
  def []=(key, value); end
  def clear_body; end
...
class Faraday::Request < Anonymous_Struct_24
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
